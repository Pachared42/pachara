...
export const SKILLS = [
  {
    skill1: <RiReactjsLine className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#61DAFB]" />,
    name: "React",
    experience: "",
  },
  {
    skill2: <SiPhp className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#8892BF]" />,
    name: "PHP",
    experience: "",
  },
  {
    skill3: <RiTailwindCssFill className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#38BDF8]" />,
    name: "Tailwind CSS",
    experience: "",
  },
  {
    skill4: <FaHtml5 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#E34F26]" />,
    name: "HTML",
    experience: "",
  },
  {
    skill5: <FaCss3Alt className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#264DE4]" />,
    name: "CSS",
    experience: "",
  },
  {
    skill6: <DiJavascript className="text-2xl sm:text-3xl md:text-[60px] lg:text-[90px] xl:text-[105px] text-[#F7DF1E]" />,
    name: "JavaScript",
    experience: "",
  },
  {
    skill7: <IoLogoGithub className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-purple-700" />,
    name: "GitHub",
    experience: "",
  },
];
...
export const TOOLS = [
  {
    tool1: <VscVscodeInsiders className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#007ACC]" />,
    name: "Visual Studio Code",
    experience: "",
  },
  {
    tool2: <IoLogoGithub className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl xl:text-8xl text-[#586069]" />,
    name: "GitHub",
    experience: "",
  },
  {
    tool3: <SiXampp className="text-2xl sm:text-3xl md:text-[50px] lg:text-[75px] xl:text-[85px] text-[#FF7A00]" />,
    name: "XAMPP",
    experience: "",
  },
  {
    tool4: <SiLaragon className="text-2xl sm:text-3xl md:text-[50px] lg:text-[75px] xl:text-[85px] text-[#1D7A8C]" />,
    name: "Laragon",
    experience: "",
  },
  {
    tool5: <SiAdobeillustrator className="text-2xl sm:text-3xl md:text-[50px] lg:text-[75px] xl:text-[85px] text-[#FF9A00]" />,
    name: "Adobe Illustrator",
    experience: "",
  },
  {
    tool6: <SiAdobephotoshop className="text-2xl sm:text-3xl md:text-[50px] lg:text-[75px] xl:text-[85px] text-[#31A8FF]" />,
...
export const DATABASES = [
  {
    database1: <SiMysql className="text-2xl sm:text-3xl md:text-[75px] lg:text-[100px] xl:text-[115px] text-[#4479A1]" />,
    name: "MySQL",
    experience: "",
  },
];
